#ifndef MCSOS_KERNEL_SCHED_H
#define MCSOS_KERNEL_SCHED_H
...
/*
 * mcsos_context_switch diimplementasikan di
 * kernel/arch/x86_64/src/context_switch.S untuk build freestanding.
 * Pada host unit test (MCSOS_HOST_TEST), fungsi ini TIDAK dipanggil;
 * test hanya memverifikasi state machine dan struktur runqueue.
 */
